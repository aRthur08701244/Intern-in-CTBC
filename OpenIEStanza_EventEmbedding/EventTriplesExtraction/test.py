...
# python setup.py install --install-lib /usr/local/lib/python3.9/site-packages/
# python pyltp/setup.py install --install-lib /usr/local/lib/python3.9/site-packages/ex
